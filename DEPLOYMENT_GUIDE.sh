...
echo "  - Should show:"
echo "    • Artwork Price (List Price): \$140"
echo "    • Venue Commission (15%): \$21"
echo "    • Buyer Support Fee (4.5%): \$6.30"
echo "    • Artist Take Home (Pro 85%): \$119"
echo "    • Platform + Processing: Remainder after payment processing"
echo ""
