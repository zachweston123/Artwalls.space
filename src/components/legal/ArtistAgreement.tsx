...
export function ArtistAgreement({ onNavigate, onAccept, hasAccepted = false }: ArtistAgreementProps) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 max-w-3xl">
          <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 sm:p-8 mb-6">
            <div className="mb-6">
              <h1 className="text-3xl mb-2 text-neutral-900 dark:text-neutral-50">Artwalls Artist Agreement</h1>
              <p className="text-sm text-neutral-500 dark:text-neutral-400">Last updated: December 25, 2024</p>
            </div>

            {/* Summary */}
            <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-5 mb-8 border border-blue-100 dark:border-blue-900">
              <h2 className="text-base text-blue-900 dark:text-blue-200 mb-2 text-neutral-900 dark:text-neutral-50">Summary (non-binding)</h2>
                ...
                <div className="mt-2 p-4 bg-neutral-50 dark:bg-neutral-900 rounded-lg border border-neutral-200 dark:border-neutral-700">
                  {sections.map((section) => (
                    <button
                      ...
                      className="block w-full text-left text-sm text-neutral-700 dark:text-neutral-300 hover:text-blue-600 dark:text-blue-400 py-2 transition-colors"
                    >
                      {section.title}
                    </button>
                  ))}
            ...
            <div className="space-y-8 prose prose-sm max-w-none">
              ...
              <section id="ownership">
                <h2 className="text-xl mb-3 text-neutral-900 dark:text-neutral-50">3. Ownership and Responsibility</h2>
              ...
              <section id="readiness">
                <h2 className="text-xl mb-3 text-neutral-900 dark:text-neutral-50">4. Artwork Readiness Requirements</h2>
              ...
              <section id="installation">
                <h2 className="text-xl mb-3 text-neutral-900 dark:text-neutral-50">5. Installation and Pickup</h2>
                <ul className="list-disc list-inside space-y-2 text-neutral-700 dark:text-neutral-300 leading-relaxed">
                  <li>
              ...
              <section id="risk">
                <h2 className="text-xl mb-3 text-neutral-900 dark:text-neutral-50">6. Display Risk; Damage, Loss, or Theft</h2>
                <ul className="list-disc list-inside space-y-2 text-neutral-700 dark:text-neutral-300 leading-relaxed">
                  <li>
              ...
              <section id="sales">
                <h2 className="text-xl mb-3 text-neutral-900 dark:text-neutral-50">7. Sales and "All Sales Final"</h2>
                <ul className="list-disc list-inside space-y-2 text-neutral-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="subscriptions">
                <h2 className="text-xl mb-3 text-neutral-900 dark:text-neutral-50">8. Subscriptions, Fees, Active Displays, and Protection Plan</h2>
                
                <h3 className="text-base mb-2 mt-4 text-neutral-900 dark:text-neutral-50">Plans</h3>
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-3">
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900 dark:text-neutral-50">Platform fee on sales</h3>
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900 dark:text-neutral-50">Revenue split on completed sales</h3>
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-2">
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900 dark:text-neutral-50">Active displays and overage pricing</h3>
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-3">
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900 dark:text-neutral-50">Payout timing</h3>
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-3">
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900 dark:text-neutral-50">Protection Plan Requirements</h3>
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-2">
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900 dark:text-neutral-50">Exclusions</h3>
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-2">
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900 dark:text-neutral-50">Claim limits</h3>
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-3">
                  Artwalls may limit claims per year by plan tier (e.g., Free/Starter up to 2, Growth up to 3, Pro up to 4).
                </p>

                <h3 className="text-base mb-2 mt-4 text-neutral-900 dark:text-neutral-50">All Sales Final</h3>
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="prohibited">
                <h2 className="text-xl mb-3 text-neutral-900 dark:text-neutral-50">9. Prohibited Content and Conduct</h2>
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="account">
                <h2 className="text-xl mb-3 text-neutral-900 dark:text-neutral-50">10. Account Actions and Removal</h2>
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="limitation">
                <h2 className="text-xl mb-3 text-neutral-900 dark:text-neutral-50">11. Limitation of Platform Responsibility</h2>
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="contact">
                <h2 className="text-xl mb-3 text-neutral-900 dark:text-neutral-50">12. Contact and Notices</h2>
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="mt-1 w-5 h-5 rounded border-neutral-300 dark:border-neutral-600 text-blue-600 dark:text-blue-400 focus:ring-2 focus:ring-blue-500"
                />
              ...
              {/* Name Input */}
              <div>
                <label className="block text-sm text-neutral-700 dark:text-neutral-300 mb-2">Your Full Name</label>
                <input
                  type="text"
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  placeholder="Enter your full name"
                  className="w-full px-4 py-2 rounded-lg border border-neutral-300 dark:border-neutral-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <nav className="space-y-2">
                {sections.map((section) => (
                  <button
                    ...
                    className="block w-full text-left text-sm text-neutral-700 dark:text-neutral-300 hover:text-blue-600 dark:text-blue-400 py-1 transition-colors"
                  >
                    {section.title}
                  </button>
                ))}
      ...
      {/* Success Toast */}
      {showSuccessToast && (
        <div className="fixed bottom-6 right-6 bg-blue-600 text-white px-6 py-4 rounded-xl shadow-lg flex items-center gap-3 animate-slide-up z-50">
          <CheckCircle className="w-5 h-5" />
