      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 max-w-3xl">
          <div className="bg-white rounded-xl border border-neutral-200 p-6 sm:p-8 mb-6">
            <div className="mb-6">
              <h1 className="text-3xl mb-2 text-neutral-900">Artwalls Artist Agreement</h1>
            ...
            <div className="bg-blue-50 rounded-lg p-5 mb-8 border border-blue-100">
              <h2 className="text-base text-blue-900 mb-2 text-neutral-900">Summary (non-binding)</h2>
                ...
                <div className="mt-2 p-4 bg-neutral-50 rounded-lg border border-neutral-200">
                  {sections.map((section) => (
                    <button
                      ...
                      className="block w-full text-left text-sm text-neutral-700 hover:text-blue-600 py-2 transition-colors"
                    >
                      {section.title}
                    </button>
                  ))}
            ...
            <div className="space-y-8 prose prose-sm max-w-none">
              ...
              <section id="ownership">
                <h2 className="text-xl mb-3 text-neutral-900">3. Ownership and Responsibility</h2>
              ...
              <section id="readiness">
                <h2 className="text-xl mb-3 text-neutral-900">4. Artwork Readiness Requirements</h2>
              ...
              <section id="installation">
                <h2 className="text-xl mb-3 text-neutral-900">5. Installation and Pickup</h2>
                <ul className="list-disc list-inside space-y-2 text-neutral-700 leading-relaxed">
                  <li>
              ...
              <section id="risk">
                <h2 className="text-xl mb-3 text-neutral-900">6. Display Risk; Damage, Loss, or Theft</h2>
                <ul className="list-disc list-inside space-y-2 text-neutral-700 leading-relaxed">
                  <li>
              ...
              <section id="sales">
                <h2 className="text-xl mb-3 text-neutral-900">7. Sales and "All Sales Final"</h2>
                <ul className="list-disc list-inside space-y-2 text-neutral-700 leading-relaxed">
              ...
              <section id="subscriptions">
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900">Revenue split on completed sales</h3>
                <p className="text-neutral-700 leading-relaxed mb-2">
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900">Active displays and overage pricing</h3>
                <p className="text-neutral-700 leading-relaxed mb-3">
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900">Payout timing</h3>
                <p className="text-neutral-700 leading-relaxed mb-3">
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900">Protection Plan Requirements</h3>
                <p className="text-neutral-700 leading-relaxed mb-2">
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900">Exclusions</h3>
                <p className="text-neutral-700 leading-relaxed mb-2">
                ...
                <h3 className="text-base mb-2 mt-4 text-neutral-900">Claim limits</h3>
                <p className="text-neutral-700 leading-relaxed mb-3">
                  Artwalls may limit claims per year by plan tier (e.g., Free/Starter up to 2, Growth up to 3, Pro up to 4).
                </p>

                <h3 className="text-base mb-2 mt-4 text-neutral-900">All Sales Final</h3>
                <p className="text-neutral-700 leading-relaxed">
              ...
              <section id="prohibited">
                <h2 className="text-xl mb-3 text-neutral-900">9. Prohibited Content and Conduct</h2>
                <p className="text-neutral-700 leading-relaxed">
              ...
              <section id="account">
                <h2 className="text-xl mb-3 text-neutral-900">10. Account Actions and Removal</h2>
                <p className="text-neutral-700 leading-relaxed">
              ...
              <section id="limitation">
                <h2 className="text-xl mb-3 text-neutral-900">11. Limitation of Platform Responsibility</h2>
                <p className="text-neutral-700 leading-relaxed">
              ...
              <section id="contact">
                <h2 className="text-xl mb-3 text-neutral-900">12. Contact and Notices</h2>
                <p className="text-neutral-700 leading-relaxed">
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="mt-1 w-5 h-5 rounded border-neutral-300 text-blue-600 focus:ring-2 focus:ring-blue-500"
                />
              ...
              {/* Name Input */}
              <div>
                <label className="block text-sm text-neutral-700 mb-2">Your Full Name</label>
                <input
                  type="text"
                  value={name}
