    ...
    <div>
      ...
      <div className="max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <h2 className="text-xl mb-2 text-neutral-900 dark:text-neutral-50">Artist Agreement</h2>
          <p className="text-sm text-neutral-600 dark:text-neutral-300 mb-4">
        ...
        >
          ...
          <h2 className="text-xl mb-2 text-neutral-900 dark:text-neutral-50">Venue Agreement</h2>
          <p className="text-sm text-neutral-600 dark:text-neutral-300 mb-4">
        ...
        >
          ...
          <h2 className="text-xl mb-2 text-neutral-900 dark:text-neutral-50">Privacy Policy</h2>
          <p className="text-sm text-neutral-600 dark:text-neutral-300 mb-4">
        ...
        >
          <div className="w-12 h-12 bg-neutral-100 dark:bg-neutral-800 rounded-lg flex items-center justify-center mb-4">
            <Scale className="w-6 h-6 text-neutral-600 dark:text-neutral-300" />
          </div>
          <h2 className="text-xl mb-2 text-neutral-900 dark:text-neutral-50">Terms of Service</h2>
          <p className="text-sm text-neutral-600 dark:text-neutral-300 mb-4">
      ...
      {/* Additional Info */}
      <div className="max-w-4xl mt-8 bg-blue-50 dark:bg-blue-900/30 rounded-xl p-6 border border-blue-100 dark:border-blue-900">
        <h3 className="text-base text-blue-900 dark:text-blue-200 mb-2 text-neutral-900 dark:text-neutral-50">Questions about our agreements?</h3>
