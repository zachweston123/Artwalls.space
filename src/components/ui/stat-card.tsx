...
function StatCard({
  ...
  return (
    <Comp
      onClick={onClick}
      className={cn(
        "group bg-[var(--surface-2)] border border-[var(--border)] rounded-xl p-5 text-left transition-colors duration-200",
        onClick &&
          "hover:border-[var(--border-hover)] hover:bg-[var(--surface-3)]/30 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg)]",
        className,
      )}
    >
      {icon && (
