            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <p className="text-sm text-neutral-600 dark:text-neutral-300">{venue.type}</p>
                </div>
                <span className="px-3 py-1 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded-full text-xs whitespace-nowrap">
              ...
              <p className="text-sm text-neutral-600 dark:text-neutral-300 mb-4 line-clamp-2">{venue.description}</p>
              ...
              <div className="mb-4">
                ...
                <div className="space-y-2">
                  {mockWallSpaces.filter(w => w.available).slice(0, 2).map((wall) => (
                    <div key={wall.id} className="p-3 bg-neutral-50 dark:bg-neutral-900 rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm mb-1 text-neutral-900 dark:text-neutral-50">{wall.name}</p>
                          <p className="text-xs text-neutral-600 dark:text-neutral-400">{wall.width}" × {wall.height}"</p>
                          {wall.photos && wall.photos.length > 0 && (
              ...
              <div className="flex items-center justify-between pt-4 border-t border-neutral-100 dark:border-neutral-700">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-blue-600 dark:bg-blue-500 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-400 transition-colors disabled:opacity-50"
        ...
        <div className="fixed inset-0 bg-black/50 dark:bg-black/70 flex items-center justify-center z-50 p-6">
          <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 max-w-2xl w-full">
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm text-neutral-700 dark:text-neutral-300 mb-3">Select Artwork</label>
                {availableArtworks.length === 0 ? (
                  <div className="text-center py-8 bg-neutral-50 dark:bg-neutral-900 rounded-lg">
                    <p className="text-neutral-600 dark:text-neutral-300">You don't have any available artworks.</p>
                    <p className="text-sm text-neutral-500 dark:text-neutral-400 mt-1">Upload a new piece to apply</p>
                  </div>
                ) : (
                    ...
                    {availableArtworks.map((artwork) => (
                      ...
                      >
                        ...
                        <div className="p-3 bg-white dark:bg-neutral-800">
                          <h4 className="text-sm mb-1 text-neutral-900 dark:text-neutral-50">{artwork.title}</h4>
                          <p className="text-xs text-neutral-600 dark:text-neutral-400">${artwork.price}</p>
                        </div>
                      </button>
                    ))}
                  </div>
              ...
              {availableArtworks.length > 0 && (
                <>
                  <div>
                    <label className="block text-sm text-neutral-700 dark:text-neutral-300 mb-2">Additional Message (Optional)</label>
                    <textarea
                      rows={4}
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      ...
                      className="flex-1 px-4 py-2 bg-blue-600 dark:bg-blue-500 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Submit Application
                    </button>
                  </div>
