      ...
      try {
        ...
        if (isMounted && profile) {
          setArtist({
            ...
            location: profile.city_primary || profile.cityPrimary || '',
            bio: profile.bio || '',
            instagram: profile.instagram_handle || profile.instagramHandle || '',
            artTypes: profile.artTypes || [],
            openToNew: profile.openToNewPlacements ?? profile.open_to_placements ?? true,
            activeDisplays: 0,
            totalSales: 0,
          });
        }
