        ...
        <div className="flex gap-3 mb-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-14 pr-4 py-3 rounded-lg border border-[var(--border)] bg-[var(--surface-2)] text-[var(--text)] placeholder:text-[var(--text-muted)] focus:outline-none focus:ring-2 focus:ring-[var(--focus)]"
            />
          </div>
          <button
