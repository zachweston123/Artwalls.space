  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-neutral-600 dark:text-neutral-300">Manage your account information and settings</p>
      </div>
        ...
        <div className="lg:col-span-2 bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 overflow-hidden">
          <div className="p-6">
            <div className="flex items-start justify-between mb-6">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-400 text-white rounded-lg transition-colors">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 p-4 bg-neutral-50 dark:bg-neutral-900 rounded-lg">
                <LinkIcon className="w-5 h-5 text-neutral-500 dark:text-neutral-400 mt-0.5" />
                <div className="flex-1">
                  <label className="block text-sm text-neutral-500 dark:text-neutral-400 mb-1">Portfolio Website</label>
                  <a 
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg text-neutral-900 dark:text-neutral-50">Earnings Summary</h3>
            </div>

            <div className="space-y-4">
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-1">Total Earnings (80%)</p>
                <p className="text-2xl text-neutral-900 dark:text-neutral-50">${profile.totalEarnings.toFixed(2)}</p>
              </div>
              
              <div className="pt-4 border-t border-neutral-200 dark:border-neutral-700">
                <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-1">Pending Payout</p>
                <p className="text-xl text-blue-600 dark:text-blue-400">${profile.pendingPayout.toFixed(2)}</p>
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">Processed monthly on the 15th</p>
              </div>
            </div>

            <button 
              onClick={() => onNavigate('artist-sales')}
              className="w-full mt-4 px-4 py-2 bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-800 transition-colors"
            >
              View Sales History
            </button>
          </div>
