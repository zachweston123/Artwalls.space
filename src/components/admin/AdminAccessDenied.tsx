      ...
      <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 flex items-center justify-center p-6">
        <div className="max-w-md w-full text-center">
          <div className="w-20 h-20 bg-neutral-100 dark:bg-neutral-800 rounded-full flex items-center justify-center mx-auto mb-6">
            <LogIn className="w-10 h-10 text-neutral-400 dark:text-neutral-600" />
          </div>
          <h1 className="text-3xl mb-3 text-neutral-900 dark:text-neutral-50">Admin Access Required</h1>
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-3xl mb-3 text-neutral-900 dark:text-neutral-50">Access Denied</h1>
        <p className="text-neutral-600 dark:text-neutral-400 mb-8">
