      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-neutral-200 overflow-hidden">
          ...
          <div className="border-t border-neutral-200 dark:border-neutral-700 p-6">
            <h3 className="text-lg mb-4 text-neutral-900">Wall Space Guidelines</h3>
            <div className="space-y-3">
              <div className="p-4 bg-neutral-50 rounded-lg">
                <p className="text-sm text-neutral-600 mb-2">
                  <strong className="text-neutral-900">Artwork Requirements:</strong>
                </p>
              ...
              >
                <p className="text-neutral-900 mb-1">Manage Guidelines</p>
                <p className="text-sm text-neutral-500">Customize your venue's artwork preferences</p>
              </button>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg text-neutral-900">Commission Earnings</h3>
            </div>

            <div className="space-y-4">
              <div>
                <p className="text-sm text-neutral-500 mb-1">Total Commission (10%)</p>
              ...
              <div className="pt-4 border-t border-neutral-200">
                <div className="grid grid-cols-2 gap-3 text-center">
                  <div className="p-3 bg-neutral-50 rounded-lg">
                    <p className="text-2xl text-neutral-900">{profile.wallSpaces}</p>
                    <p className="text-xs text-neutral-500 mt-1">Wall Spaces</p>
                  </div>
                  <div className="p-3 bg-neutral-50 rounded-lg">
                    <p className="text-2xl text-green-600">{profile.activeDisplays}</p>
            ...
            <button 
              ...
              className="w-full mt-4 px-4 py-2 bg-green-50 text-green-700 rounded-lg hover:bg-green-100 transition-colors"
            >
              View Sales Report
            </button>
          </div>
