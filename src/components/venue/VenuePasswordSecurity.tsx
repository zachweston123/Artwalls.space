...
interface VenuePasswordSecurityProps {
  onBack: () => void;
}

export function VenuePasswordSecurity({ onBack }: VenuePasswordSecurityProps) {
          ...
          <div className="bg-[var(--surface-1)] rounded-xl border border-[var(--border)] p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-[var(--text-muted)]">Update your password to keep your venue account secure</p>
              </div>
            </div>
