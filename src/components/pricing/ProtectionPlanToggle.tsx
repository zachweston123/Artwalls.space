    ...
    <div className="bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 p-4">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-3 flex-1">
          <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
            isProtected ? 'bg-green-100 dark:bg-green-900' : 'bg-neutral-100 dark:bg-neutral-800'
          }`}>
            <Shield className={`w-5 h-5 ${isProtected ? 'text-green-600 dark:text-green-400' : 'text-neutral-400 dark:text-neutral-500'}`} />
          </div>
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              ...
              <button
                ...
                className="text-neutral-400 dark:text-neutral-500 hover:text-neutral-600 dark:text-neutral-300"
              >
        ...
        <label className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            className="w-5 h-5 rounded border-neutral-300 dark:border-neutral-600 text-blue-600 dark:text-blue-400 focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
          />
      ...
      {showInfo && (
        <div className="mt-4 pt-4 border-t border-neutral-200 dark:border-neutral-700">
          <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-3 text-xs text-blue-900 dark:text-blue-200 space-y-2">
            ...
            <button
              ...
              className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:text-blue-300 underline mt-2"
            >
