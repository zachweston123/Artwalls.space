...
export function LabelChip({ 
  ...
  const colorClasses = selected
    ? role === 'artist'
      ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 border-2 border-blue-500 dark:border-blue-400'
      : 'bg-green-50 dark:bg-green-900/50 text-green-700 dark:text-green-300 border-2 border-green-500 dark:border-green-400'
